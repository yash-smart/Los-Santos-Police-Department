function updateList() {
    ...
    // console.log(document.querySelector('#job-post'))
    document.querySelector('#job-post').remove();
    ...
    for (let i=0;i<newData.length;i++) {
        ...
        descriptionElement.innerHTML = '<strong>Description:</strong> '+newData[i].description;
        ...
        ApplyButton.href = 'applications/'+newData[i].id;
        ApplyButton.innerHTML = '<button class="apply-button">See Applications</button>';
        deleteJobButton = document.createElement('a');
        deleteJobButton.innerHTML = '<button class="apply-button delete-button">Delete Job</button>'
        ...
        new_job_element.append(deleteJobButton)
        job_listings.append(new_job_element);
    }
    let AddButton = document.createElement('a');
    AddButton.href = '/job-post';
    AddButton.innerHTML = '<button class="apply-button" id="job-post">New Post</button>';
    job_listings.append(AddButton);
}
